            ...
            <section className="bloc-content">
                    ...
                    <div className="bloc_1">
                        <h2>ils meritent le meilleurs. Nous leur offrons le meilleur</h2>
                            <p>lorem ipsum Ut aliquet porta egestas. Aliquam erat volutpat. Pellentesque euismod ipsum non mi volutpat euismod. Curabitur mollis, velit eu venenatis semper, mi dolor scelerisque nisi, id interdum risus nulla quis ligula. Phasellus tortor sem, tincidunt id tortor fermentum, tincidunt sagittis turpis. Integer viverra justo id sagittis sollicitudin. Integer gravida a eros eu facilisis. Proin ultrices leo non ultricies sagittis</p>
                    </div>
